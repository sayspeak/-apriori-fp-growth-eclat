...
if __name__ == '__main__':
    dataSetDict, dataSet = loadDblpData(open('/Users/apple/PycharmProjects/Apriori/freqpattern-master/datasets/dataSetTest.txt'))
    f = open('/Users/apple/PycharmProjects/Apriori/freqpattern-master/datasets/dataSetTest.txt')
